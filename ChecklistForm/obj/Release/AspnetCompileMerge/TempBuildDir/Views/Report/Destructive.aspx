    ...
    
{
     if(!IsPostBack)
     {
         ...
         //    ad.Fill( ds );
           ...
           //  ds = (System.Data.DataTable)Session["Reports2"];
             if (Session["Reports"] != null)
             {
                 dt = (System.Data.DataTable)Session["Reports"];
                 ReportViewer1.LocalReport.ReportPath = System.IO.Path.Combine(Server.MapPath("~/Reports"), "Destructive.rdlc");
             }
             else
             {
                 dt = (System.Data.DataTable)Session["Reports2"];
                 ReportViewer1.LocalReport.ReportPath = System.IO.Path.Combine(Server.MapPath("~/Reports"), "DestructiveShift.rdlc");
             }
           //  ReportViewer1.LocalReport.ReportPath = System.IO.Path.Combine(Server.MapPath("~/Reports"), "DestructiveShift.rdlc");
             ReportViewer1.LocalReport.DataSources.Clear();
             ReportDataSource rdc = new ReportDataSource("DataSet1", dt);
           //  ReportDataSource rdc1 = new ReportDataSource("DataSet2", ds);
