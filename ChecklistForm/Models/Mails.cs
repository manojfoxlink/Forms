...
namespace ChecklistForm.Models
{
    public class Mails
    {
            ...
            public void NotificationEmail(int Status, string Mail)
            {
            ...
            private string GetEmailContent(string Mail)
            {
                ...
                using (StreamReader reader = new StreamReader(System.Web.HttpContext.Current.Server.MapPath("~/EmailTemplates/CIPAuditNGAlert.html")))
                {
