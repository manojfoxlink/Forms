...
namespace ChecklistForm.Models
{
    public class MailForFACA
    {
            ...
            private string GetEmailContent(string Mail)
            {
                ...
                DataTable dt = _checkResult.GetParameterFACAProdCheckListQualityAudit();

                using (StreamReader reader = new StreamReader(System.Web.HttpContext.Current.Server.MapPath("~/EmailTemplates/FACAAlert.html")))
                {
                ...
                string htmlString = " <table style='border-collapse: collapse,width: 100%;'width='100%' border=1 align=center cellpadding=1 cellspacing=3><tr style='background-color:lightgreen' ><th>CreatedDate</th><th>Project</th><th>Line</th><th>Batch</th><th>Zone</th><th>Station</th><th>Activity Description</th><th>Description</th><th>Root Cause</th><th>Corrective Action</th><th>Preventive Action</th><th>ProductionLineLeader</th></tr>";
                // string htmlString = " <table style='border-collapse: collapse,width: 100%;'width='100%' border=0 align=center cellpadding=0 cellspacing=0><tr  ><th>IssueType</th><th>Project</th><th>Line</th><th>Adhesive Specification</th><th>Status</th><th>Submitted time</th><th>FeedBack</th></tr>";ProductionLineLeader
                for (int loopCount = 0; loopCount < dt.Rows.Count; loopCount++)
                {
                    htmlString += "<tr><td>" + Convert.ToDateTime(dt.Rows[loopCount]["CreateDate"]).ToString("yyyy-MM-dd") + "</td><td>"
                                             ...
                                             + dt.Rows[loopCount]["Descrription"] + "</td><td>"
